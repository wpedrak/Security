...
SP_CERTIFICATE_FILE = KEY_DIR / 'sp-kogucik-certificate.pem'
SP_PRIVATE_KEY_FILE = KEY_DIR / 'sp-kogucik-private-key.pem'
...
app.config['SERVER_NAME'] = 'www.kogucik.pl:9001'
app.config['SAML2_SP'] = {
    'issuer': 'Test SP',
...
def index():
    if sp.is_user_logged_in():
        ...
        message = f'''
        <h3>Welcome to <strong>KOGUCIK</strong> service. Nice to eat you.</h3>
...
if __name__ == '__main__':
    app.run(host='www.kogucik.pl', port=9001)
